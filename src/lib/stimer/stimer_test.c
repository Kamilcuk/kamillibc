...
static inline clock_t stimer_elapsedTimeSinceLastArm_Callback_test()
{
	return stimer_test.elapsed;
}
static inline void stimer_IRQDisable_Callback_test()
{
	stimer_test.irqdisabled = true;
}
static inline void stimer_IRQEnable_Callback_test()
{
